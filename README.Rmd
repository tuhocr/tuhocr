...
Package này tập hợp các function giúp giải quyết công việc xử lý dữ liệu thường ngày. Để biết cách viết function, thân mời bạn tham gia khóa học R ở **`www.tuhocr.com`** giúp trang bị kiến thức R vững chắc.
...
Sử dụng function `filter_faostat` để trích xuất dữ liệu nông sản từ FAOSTAT. Hướng dẫn chi tiết xem ở đây.
