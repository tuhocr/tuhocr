...
Áp dụng function `extract_faostat()` và `filter_faostat()` để trích xuất dữ liệu cây trồng từ FAOSTAT. [Hướng dẫn chi tiết](https://tuhocr.github.io/articles/filter_faostat.html)
